...
# -------------------------------------------------
BUSINESS_QUERIES = [
    "Roof Maintenance and Repair Service in",
    "Gutter and Fascia Cleaning Service in",
    "Roof Survey Service in",
    "Drone Roof Survey Service in",
    "Asbestos Remedial Service in",
]
