...
# -------------------------------------------------
BUSINESS_QUERIES = [
    "Drainage and Flood Management Contractor in",
    "Geotechnical Contractor in",
    "Remediation and Land Regeneration Contractor in",
    "Vegetation Management Contractor in",
]
